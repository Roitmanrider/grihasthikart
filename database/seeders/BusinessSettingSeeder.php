...
class BusinessSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['checkout', 'cart_hold_minutes', '120', 'integer', 'Cart Hold Duration', 8],
            ['checkout', 'cart_reminder_minutes', '30', 'integer', 'Abandoned Cart Reminder After', 9],
            ['checkout', 'default_state', null, 'string', 'Default State', 10],
            ['checkout', 'default_city', null, 'string', 'Default City', 11],
            ['checkout', 'store_contact_mobile', null, 'string', 'Store Contact Mobile', 12],
            ['checkout', 'store_whatsapp_number', null, 'string', 'Store WhatsApp Number', 13],
