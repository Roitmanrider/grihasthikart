    ...
    <div class="col-xl-8">
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white">
                <h2 class="h5 mb-0">Category Information</h2>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="display_order" value="{{ old('display_order', $category->display_order ?? 0) }}" class="form-control @error('display_order') is-invalid @enderror" min="0">
                        @error('display_order') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Slug</label>
                        <input type="text" name="slug" value="{{ old('slug', $category->slug ?? '') }}" class="form-control @error('slug') is-invalid @enderror" placeholder="Auto generated when empty">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="meta_description" rows="3" class="form-control @error('meta_description') is-invalid @enderror">{{ old('meta_description', $category->meta_description ?? '') }}</textarea>
                        @error('meta_description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-12">
                        <label class="form-label">Meta Keywords</label>
                        <textarea name="meta_keywords" rows="2" class="form-control @error('meta_keywords') is-invalid @enderror">{{ old('meta_keywords', $category->meta_keywords ?? '') }}</textarea>
    ...
    <div class="col-xl-4">
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-check form-switch mb-3">
                    <input type="checkbox" name="is_featured" value="1" class="form-check-input" id="is_featured" @checked(old('is_featured', $category->is_featured ?? false))>
                    <label class="form-check-label" for="is_featured">Featured category</label>
                </div>

                <div class="form-check form-switch mb-3">
                    <input type="checkbox" name="show_in_menu" value="1" class="form-check-input" id="show_in_menu" @checked(old('show_in_menu', $category->show_in_menu ?? true))>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    @if (! empty($category?->image))
                        <div class="border rounded p-2 mb-2">
                            <img src="{{ app(\App\Services\MediaResolver::class)->url($category->image) }}" alt="{{ $category->name }}" class="img-fluid rounded" style="max-height: 140px; object-fit: contain;">
                            <div class="small text-muted mt-2">{{ $category->image }}</div>
                ...
                <div class="mb-3">
                    ...
                    @if (! empty($category?->banner))
                        <div class="border rounded p-2 mb-2">
                            <img src="{{ app(\App\Services\MediaResolver::class)->url($category->banner) }}" alt="{{ $category->name }} banner" class="img-fluid rounded" style="max-height: 140px; object-fit: contain;">
                            <div class="small text-muted mt-2">{{ $category->banner }}</div>
                            <div class="form-check mt-2">
                                ...
                                <label class="form-check-label" for="remove_banner">Remove banner</label>
                            </div>
                        </div>
                    @endif
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="{{ old('icon', $category->icon ?? '') }}" class="form-control @error('icon') is-invalid @enderror" placeholder="fa fa-apple-whole">
