...
<div class="row g-4">
<div class="col-md-4"><div class="card border-0 shadow-sm"><div class="card-body"><div class="fw-semibold">{{ $customer->name }}</div>@if($customer->is_premium)<span class="badge text-bg-success mt-2">Premium</span>@endif<div class="mt-2"><a href="{{ route('customer.cashback.index') }}">Cashback</a></div></div></div></div>
