...
@section('content')
    <section class="py-5" style="background: linear-gradient(135deg, #f1f8f3 0%, #fff8ed 100%);">
        <div class="container">
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    ...
                    <p class="lead text-muted">Explore Indian grocery staples by category, brand, and pack variant with cart, coupons, cashback, and delivery-ready checkout.</p>
    ...
    <section class="py-5">
        <div class="container">
            ...
            @else
                <x-empty-state title="Categories are coming soon" message="The grocery catalog is ready for categories as soon as seed data is available." />
            @endif
        </div>
    </section>
